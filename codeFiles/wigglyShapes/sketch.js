...
const colors = ["#93B399", "#67A072", "#84BC8F",
  "#F1E4D1", //tan
  "#F1734B", //orange
  "#FFFFFA" //white
]
...
function draw() {
  ...
  if(mousePoints.length >0){
    ...
    for(let i = 0; i<mousePoints.length-1; i++){
      line( mousePoints[i][0] , mousePoints[i][1],
        mousePoints[i+1][0] , mousePoints[i+1][1]
       )
    }
    line(mousePoints[mousePoints.length-1][0], mousePoints[mousePoints.length-1][1],mouseX,mouseY)
  }
