...
const p5_sketch_data = [
    ...
    new Sketch(
        ...
        code_link = './codeFiles/wigglyShapes/index.html',
        images = ['shapes.gif'],
        main_color = "#F1ECE5",
        image_folder = './assets/sketch_images/',
        show_code = true
    ...
    new Sketch(
        ...
        project_link =undefined,
        date = '2024',
        description = 'type something! I built off of my wiggly shapes code for this.',
        code_link =  './codeFiles/wigglyFont/index.html',
